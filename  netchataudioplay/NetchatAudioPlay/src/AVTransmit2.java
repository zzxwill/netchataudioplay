...
public class AVTransmit2 {
	...
	//   java AVTransmit2 file:/C:/media/test.mov  129.130.131.132 42050
    	 ...
    	 *     直接设置三个参数
    	 */
//    	args[0]="file:/F:/lanlianhua.mav";
//    	args[1]="129.130.131.132";
//    	args[2]="42050";
//	if (args.length < 3) {
//	    prUsage();
//	}
...
//	MediaLocator media=new MediaLocator()
	AVTransmit2 at = new AVTransmit2(new MediaLocator("file:/F:/lanlianhua.wav"),
			"192.168.1.200", "8000", fmt);
	// Start the transmission
